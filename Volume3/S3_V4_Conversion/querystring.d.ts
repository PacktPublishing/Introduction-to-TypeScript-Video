...
interface QuerystringStatic {
    ...
    encode(obj: string | boolean | number | null, sep: string | null, eq: string | null, name: string | boolean | number): string;
    stringify(obj: string | boolean | number | null, sep: string | null, eq: string | null, name: string | boolean | number): string;
}
